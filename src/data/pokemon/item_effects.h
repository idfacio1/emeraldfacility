...
const u8 *const gItemEffectTable[ITEMS_COUNT] =
{
    ...
    [ITEM_ALOLA_STONE]        = gItemEffect_EvoItem,
    [ITEM_FUTURE_STONE]        = gItemEffect_EvoItem,
    [ITEM_GALAR_STONE]        = gItemEffect_EvoItem,
    [ITEM_HISUI_STONE]        = gItemEffect_EvoItem,
    [ITEM_HOENN_STONE]        = gItemEffect_EvoItem,
    [ITEM_JOHTO_STONE]        = gItemEffect_EvoItem,
    [ITEM_KALOS_STONE]        = gItemEffect_EvoItem,
    [ITEM_KANTO_STONE]        = gItemEffect_EvoItem,
    [ITEM_ODDITY_STONE]        = gItemEffect_EvoItem,
    [ITEM_PALDEA_STONE]        = gItemEffect_EvoItem,
    [ITEM_PAST_STONE]        = gItemEffect_EvoItem,
    [ITEM_SINNOH_STONE]        = gItemEffect_EvoItem,
    [ITEM_UNOVA_STONE]        = gItemEffect_EvoItem,
