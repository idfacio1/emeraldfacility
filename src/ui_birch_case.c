...
{
    [BALL_TOP_FIRST]        = {SPECIES_FROAKIE, 6, ITEM_MYSTIC_WATER, BALL_LUXURY, NATURE_JOLLY, 1, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_GROWL, MOVE_POUND, MOVE_WATER_GUN, MOVE_FIRE_PLEDGE}, 0, 0, 0},
    [BALL_TOP_SECOND]       = {SPECIES_SPRIGATITO, 6, ITEM_MIRACLE_SEED, BALL_DUSK, NATURE_JOLLY, 1, MON_FEMALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_TAIL_WHIP, MOVE_SCRATCH, MOVE_LEAFAGE, MOVE_WATER_PLEDGE}, 0, 0, 0},
    [BALL_MIDDLE_FIRST]     = {SPECIES_SCORBUNNY, 6, ITEM_CHARCOAL, BALL_PREMIER, NATURE_JOLLY, 1, MON_FEMALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_GROWL, MOVE_TACKLE, MOVE_EMBER, MOVE_GRASS_PLEDGE}, 1, 0, 0},

    [BALL_TOP_THIRD]        = {SPECIES_AXEW, 6, ITEM_DRAGON_FANG, BALL_FRIEND, NATURE_JOLLY, 1, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_LEER, MOVE_SCRATCH, MOVE_BITE, MOVE_SPIRIT_BREAK}, 0, 0, 0},
    [BALL_TOP_FOURTH]       = {SPECIES_TINKATINK, 6, ITEM_FAIRY_FEATHER, BALL_DREAM, NATURE_JOLLY, 1, MON_FEMALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_ASTONISH, MOVE_FAIRY_WIND, MOVE_BABY_DOLL_EYES, MOVE_CRABHAMMER}, 0, 0, 0},
    [BALL_MIDDLE_THIRD]     = {SPECIES_GASTLY, 6, ITEM_SPELL_TAG, BALL_MOON, NATURE_JOLLY, 0, MON_FEMALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_LICK, MOVE_CONFUSE_RAY, MOVE_HYPNOSIS, MOVE_STRANGE_STEAM}, 1, 0, 0},

    [BALL_MIDDLE_SECOND]    = {SPECIES_LILLIPUP, 6, ITEM_SILK_SCARF, BALL_TIMER, NATURE_JOLLY, 0, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_LEER, MOVE_TACKLE, MOVE_WORK_UP, MOVE_MYSTICAL_POWER}, 0, 0, 0},
    [BALL_BOTTOM_FIRST]     = {SPECIES_EEVEE, 6, ITEM_EVIOLITE, BALL_BEAST, NATURE_JOLLY, 2, MON_FEMALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_COVET, MOVE_TACKLE, MOVE_SAND_ATTACK, MOVE_HIDDEN_POWER}, 1, 0, 0},
    [BALL_BOTTOM_SECOND]    = {SPECIES_PIKACHU, 6, ITEM_MAGNET, BALL_ULTRA, NATURE_JOLLY, 0, MON_MALE, {0, 0, 0, 0, 0, 0}, {31, 31, 31, 31, 31, 31}, {MOVE_QUICK_ATTACK, MOVE_NUZZLE, MOVE_THUNDER_SHOCK, MOVE_ICE_FANG}, 1, 0, 0},
