...
#define MAP_EMERALD_FACILITY_HUB     (57 | (0 << 8))
#define MAP_EMERALD_FACILITY_CANTEEN (58 | (0 << 8))
...
#define MAP_BIRCHS_NEW_LAB                        (5 | (1 << 8))
#define MAP_EMERALD_FACILITY_SAFARI_ZONE_ENTRANCE (6 | (1 << 8))
